    ...
    margin-top: 150px;">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            <table style="margin-top: 40px;">
                <tr>
                    <td>
                        <img src="<?php echo $img  ?>" alt=""style="margin-left: 120px; width: 200px;height:300px;">
                    </td>
                    <td class="users-infos">
                        <div style="margin-left: 20px;">
                            ...
                            <input id="btnnum" type="number" value="1" max="5"  name="txtnum"><br><br>
                            <input style="width:100px; height:30px; background: blue;" type="submit" name="txtsubmit" value="Borrow Now" formaction="users-borrow-code.php?updateid=<?php echo $id; ?>&categoryid=<?php echo$CATE ?>">
                        </div>
