                ...
                <tr>
                    ...
                    <td>
                        <select style="width: 150px; height: 30px;" name="txtfilter" id="">
                            ...
                            <option value="ASC">--Fast moving--</option>
                            <option value="DESC">--Slow moving--</option>
                        </select>        
                    </td>
                    <td>
                    ...
                    <td>
                        <form action="admin-books-search.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input style="width:200px;" type="text" name="txtsearch" title="enter bookname/Author/Category">
